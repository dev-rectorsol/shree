        ...
        <form method="post" id="" action="<?php echo base_url('admin/Orders/edit_order_product/').$order_data->product_order_id?>">
          <!-- <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fa fa-plus"></i> Edit Order Order Details</h5>
            </div>
            <div class="modal-body">
              <table>
                ...
                <tbody id="">
                  <tr>
                    <td><input type="text" class="form-control" name="serial_number" value="<?php echo $order_data->series_number;?>"></td>
                    <td><input type="text" name="unit" class="form-control" value="<?php echo $order_data->unit;?>"></td>
                    <td><input type="text" class="form-control" name="quantity" value="<?php echo $order_data->quantity;?>"></td>
                    <td> <input type="text" class="form-control" name="priority" value="<?php echo $order_data->priority;?>"></td>
                    <td> <input type="text" class="form-control" name="order_barcode" value="<?php echo $order_data->order_barcode;?>"></td>
                    <td><input type="text" class="form-control" name="remark" value="<?php echo $order_data->remark;?>"></td>
                    <td> <input type="text" name="fabric_name" class="form-control" value="<?php echo $order_data->fabric_name;?>"></td>
                    <td><input type="text" class="form-control" name="hsn" value="<?php echo $order_data->hsn;?>"></td>
                    <td><input type="text" name="design_name" class="form-control" value="<?php echo $order_data->design_name;?>"></td>
                    <td> <input type="text" name="design_code" class="form-control" value="<?php echo $order_data->design_code;?>"></td>
                    <td><input type="text" class="form-control" name="stitch" value="<?php echo $order_data->stitch;?>"></td>
                    <td> <input type="text" class="form-control" name="dye" value="<?php echo $order_data->dye;?>"></td>
                    <td><input type="text" class="form-control" name="matching" value="<?php echo $order_data->matching;?>"></td>
              ...
              <!-- <div class="col-md-3 align-center"><br>
                ...
                <input type="submit" name="action" id="order_btn2" class="btn btn-info btn-block" value="Update " />
              </div>
            </div>
          </div> -->
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fa fa-plus"></i>Edit Order Details</h5>
            </div>
            <div class="modal-body">
