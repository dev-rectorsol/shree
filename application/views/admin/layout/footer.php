...
<!-- <script src="<?php echo base_url('optimum/admin') ?>//dist/js/pages/dashboards/dashboard1.js"></script> -->
<!-- Charts js Files -->
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/excanvas.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/jquery.flot.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/jquery.flot.pie.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/jquery.flot.time.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/jquery.flot.stack.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot/jquery.flot.crosshair.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
<script src="<?php echo base_url('optimum/admin') ?>/dist/js/pages/chart/chart-page-init.js"></script>
<!-- <script src="<?php echo base_url('optimum/admin') ?>/assets/extra-libs/multicheck/datatable-checkbox-init.js"></script>
