                  ...
                  <thead>
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" name="challan_type" class="form-control form-control-sm" value=""
                            placeholder="ChallanType"></td>
                        <td>
                          <input type="text" name="challan_from" class="form-control form-control-sm" value=""
                            placeholder="ChallanFrom"></td>
                        <td>
                          <input type="text" name="challan_to" class="form-control form-control-sm" value=""
                            placeholder="ChallanTo"></td>
