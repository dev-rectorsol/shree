          ...
          <div class="col-md-12 ">
                      ...
                      <div class="modal-body">
                        <form action="<?php echo base_url('/admin/Orders/filter1'); ?>" method="post">
                          <div class="form-row">
                            ...
                            <input type="hidden" name="type" value="src"><input type="hidden" name="search" value="simple">
            ...
            <div class="card-body">
              <div id="overlay">
                ...
                <table class="table table-striped  table-responsive  table-bordered data-table" id="src_details">
                   <thead>
              ...
              <tbody>
                <?php  foreach ($src as $value) { ?>
                        ...
                        <td><?php echo $value['fabName'];?></td>
                        <td><?php echo $value['purchase'];?></td>
                        <td><?php echo $value['fabCode'];?></td>
                        <td><?php echo $value['sale_rate'];?></td>
                    </tr>
                <?php }?>
            </tbody>
        </table>
              <p><button id='download_src'>Download as CSV</button></p>
